def main():
   ...
   # ]
    ...
    print("Enter the elements in the sudoku board below. Elemens in the same row must be seperated by a space.")
    print("Elements in the same column must be seperated by a new line")
